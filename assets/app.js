...
var app = angular.module('MyApp', ['ngMaterial','ngRoute','hm.readmore','ui.router','ui.bootstrap','ngStorage','ngProgress','ngAnimate','ngTouch','angularModalService','dibari.angular-ellipsis','moment-picker','angular-hmac-sha512','ngSanitize','angular-preload-image','google-maps','timer','ngMessages']);
